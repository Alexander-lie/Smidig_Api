    ...
    endpoints: [
        {
            ...
            login: "POST. Returns 200 if username/password is correct, else returns 401"
        }
    ]
}
    ...
    results: [
        {
            ...
            wrong_answer: ["Et fall som har blitt kvernet", "En kvern som faller", "En foss som har et kvernetfall"],
